...
namespace Sotrydniki
{
    ...
    {
        private float dob_dn = 3;
        private float dob_noch = 6;
        ...
        {
            zar_pl = (60000 * ((pererabotka_dn * (dob_dn / 100)) + (pererabotka_n * (dob_noch / 100)))) + zar_pl;
            zar_pl2 = (60000 * ((pererabotka_dn_2 * (dob_dn / 100)) + (pererabotka_n_2 * (dob_noch / 100)))) + zar_pl2;
            zar_pl = zar_pl + 30000;
